...
export const TOGGLE_POLL_STATE_REQUEST = 'TOGGLE_POLL_STATE_REQUEST';
export const TOGGLE_POLL_STATE_SUCCESS = 'TOGGLE_POLL_STATE_SUCCESS';
export const TOGGLE_POLL_STATE_FAILURE = 'TOGGLE_POLL_STATE_FAILURE';
